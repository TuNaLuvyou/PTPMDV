      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                _buildStatCard('Đang có mặt', '$presentCount', Colors.green, Icons.check_circle),
                const SizedBox(width: 10),
                _buildStatCard('Đi muộn', '$lateCount', Colors.orange, Icons.watch_later_outlined),
                const SizedBox(width: 10),
                _buildStatCard('Vắng mặt', '$absentCount', AppColors.error, Icons.cancel_outlined),
              ],
            ),
          ),
