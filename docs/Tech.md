# Tech.md — Danh Mục Công Nghệ (Technology Stack) — PTPMDV
...
| **Mobile App** | **Flutter** | Dart 3.x, Flutter 3.x, Material 3, `go_router`, Google Fonts | Ứng dụng di động đa nền tảng (Android/iOS) cho nhân viên chấm công, xem ca, duyệt đơn, nhận lương |
...
- **Công nghệ**: Flutter 3.x, ngôn ngữ Dart 3.x.
- **UI & Trải nghiệm**: Material 3, hỗ trợ theme thương hiệu `#8E1B2F`, font chữ Public Sans (Google Fonts).
- **Điều hướng & Kiến trúc**: `go_router` làm Router SSOT, kiến trúc Feature-First.
- **Tính năng chính**:
  - Đăng nhập & bảo mật phiên bằng JWT.
  - Chấm công qua định vị / Wi-Fi chi nhánh.
  - Xem lịch làm việc cá nhân, nhận thông báo phân ca.
  - Gửi và theo dõi đơn từ (nghỉ phép, đổi ca, khiếu nại công).
  - Tra cứu phiếu lương chi tiết từng tháng.
