...
import type { WifiConfig } from "@/mock-data/portal";
  ...
  const columns: Column<WifiConfig>[] = [
    {
      ...
      render: (w) => (
        <div className="flex items-center gap-2.5">
          <span className="w-8 h-8 rounded-lg bg-info-100 text-info-700 flex items-center justify-center"><IconWifi size={16} /></span>
