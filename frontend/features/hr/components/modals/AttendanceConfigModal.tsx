      ...
      <div className="flex flex-col gap-4">
        <div className="rounded-xl border border-gray-200 p-4">
          <div className="flex items-center gap-2 mb-4">
            <span className="w-7 h-7 rounded-lg bg-danger-50 text-danger-700 flex items-center justify-center shrink-0"><IconCoin size={15} /></span>
        ...
        <div className="rounded-xl border border-gray-200 p-4">
          <div className="flex items-center gap-2 mb-4">
            <span className="w-7 h-7 rounded-lg bg-success-50 text-success-700 flex items-center justify-center shrink-0"><IconArrowsExchange size={15} /></span>
