...
export default function BankHeaderStats({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-2xs hover:border-gray-300 transition-colors">
        ...
        <div className="flex items-baseline gap-2.5">
          ...
          <span className="text-xs text-gray-400 font-medium">
            (Thời gian phản hồi: {gatewayConfig.avgResponseTime})
          </span>
        </div>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-2xs hover:border-gray-300 transition-colors">
        ...
        <div className="text-xs text-gray-500 font-mono mt-0.5">
          Số tài khoản nguồn: <span className="font-bold text-gray-800">{primaryBank.accountNumber}</span>
        </div>
        <div className="mt-4 flex items-center justify-between text-xs border-t border-gray-100 pt-3 text-gray-600">
