...
export const employees: Employee[] = [
  ...
  },
  {
    ...
    hourlySalary: 38_000,
    bankName: "BIDV",
    bankAccountNumber: "21510001234567",
    bankAccountName: "PHAM QUYNH TRANG",
  },
  {
    id: "e-staff-3",
    name: "Hoàng Minh Đức",
    ...
    bankAccountNumber: "19033445566012",
    bankAccountName: "HOANG MINH DUC",
  },
  {
    id: "e-staff-4",
    name: "Trần Bích Ngọc",
    ...
    hourlySalary: 30_000,
    bankName: "MBBank",
    bankAccountNumber: "088899991234",
    bankAccountName: "TRAN BICH NGOC",
  },
];
...
export const departments: Department[] = [
  {
    ...
    name: "Ban Giám Đốc",
    code: "BGD",
    description: "Điều hành chiến lược, phê duyệt kế hoạch và quản trị tổng thể doanh nghiệp",
  ...
  },
  {
    ...
    code: "PKD",
    description: "Phát triển thị trường chuỗi, doanh thu và quan hệ khách hàng",
  ...
  },
  {
    ...
    name: "Phòng Kế Toán",
    code: "PKT",
    description: "Quản lý dòng tiền, quyết toán bảng lương và kết nối đối soát ngân hàng",
    manager: "Phạm Quỳnh Trang",
    status: "hoạt động",
    staff: 1,
    createdAt: "01/01/2024",
  },
  {
    ...
    name: "Phòng Nhân Sự",
    code: "PNS",
    description: "Tuyển dụng, quy chế kỷ luật, đào tạo nội bộ và chính sách phúc lợi",
  ...
  },
  {
    ...
    name: "Phòng Vận Hành",
    code: "PVH",
    description: "Điều phối ca kíp, giám sát trực ca tại chuỗi chi nhánh và dịch vụ tại chỗ",
  ...
  {
    id: "dept-pcntt",
    name: "Phòng Kỹ Thuật & CNTT",
    code: "PCNTT",
    description: "Quản trị hạ tầng máy chủ On-Premises, mạng Wi-Fi và an toàn thông tin",
    manager: "Lê Văn An",
    status: "hoạt động",
    staff: 0,
    createdAt: "01/01/2024",
